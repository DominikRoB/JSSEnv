...
class TestSolution(unittest.TestCase):
    ...
    def test_optimum_ta41(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta41"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta42(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta42"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta43(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta43"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta44(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta44"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta45(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta45"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta46(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta46"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta47(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta47"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta48(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta48"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta49(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta49"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta50(self):
        ...
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta50"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
    ...
    def test_optimum_ta51(self):
        env = gym.make(
            "JSSEnv:JSSEnv-v1",
            env_config={"instance_path": "../JSSEnv/envs/instances/ta51"},
        )
        env.reset()
        self.assertEqual(env.current_time_step, 0)
        # for every machine give the jobs to process in order for every machine
